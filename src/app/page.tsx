        ...
        <div className="mt-8 bg-blue-50 p-6 rounded-lg">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="font-mono mt-1">VSWR = (1 + |Γ|) / (1 - |Γ|)</p>
            </div>
            ...
            <div>
              ...
              <p className="font-mono mt-1">Γ = (Zₗ - Z₀) / (Zₗ + Z₀)</p>
            </div>
            ...
            <div>
              ...
              <p className="font-mono mt-1">Z(x) = Z₀ × [(Zₗ + Z₀ × tanh(γx)) / (Z₀ + Zₗ × tanh(γx))]</p>
            </div>
            ...
            <div>
              ...
              <p className="font-mono mt-1">γ = α + jβ</p>
            </div>
          </div>
        </div>
      </main>
